...
const TashkilotQoshish = () => {
    ...
    const Change = async () => {
        await axios
        .put(`${config.SERVER_URL}tashkilot/${tash._id}`, Text)
        .then((res) => {
    ...
    return (
        <div className="addTashkilot bg-light h-100 pt-2 ">
            <form onSubmit={Submit} className="m-5 py-5 pe-5 bg-white addTash position-relative">
                ...
                <div className="mt-5 text-center">
                    <Button ButtonFunction={Change} ButtonStyle={"oq-button"} name="Янгилаш" />
                </div>
